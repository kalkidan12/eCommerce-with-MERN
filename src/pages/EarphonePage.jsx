...
function EarphonePage() {
	...
	const earphone = product.filter(
		(product) => product.catagory == "earphone" && product.price <= range,
	);
	...
	return (
		<div>
			...
			<div className="home-title">
				<h1></h1>
				<h2>List of available eaarphones in our atore</h2>
			</div>
			<div className="trending-product-list">
				{earphone.length &&
					earphone.map((product, key) => (
